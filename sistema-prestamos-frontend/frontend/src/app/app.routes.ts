...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'libros/:id', loadComponent: () => import('./dashboard/libro-detalle/libro-detalle.component').then(m => m.LibroDetalleComponent) },
...

  {
    ...
    children: [
      ...
      { path: 'catalogo/:id', loadComponent: () => import('./dashboard/libro-detalle/libro-detalle.component').then(m => m.LibroDetalleComponent) },
